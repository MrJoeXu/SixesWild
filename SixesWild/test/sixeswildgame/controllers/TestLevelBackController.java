 ...
 *
 */
public class TestLevelBackController extends TestCase {
	public void test() throws FileNotFoundException, FontFormatException,
		...
		LevelBackController lbc = new LevelBackController(world, application,
				level);

		lbc.actionPerformed(null);

		assertEquals(application.getLevelSelectorView(), application
				.getFrmSixesWild().getContentPane());
	}
}